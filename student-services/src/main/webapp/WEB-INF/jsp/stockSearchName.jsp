...
<body class="bg-light">
    <!-- Create navigation for the website within a <header> tag -->
     ...
     <main class="container text-center">
      <h4>Search by Stock Name</h4>
    	 <form method="POST" action="/stockBrowse/searchStockName">
                    <input class="form-control" type="text" name="stockName" placeholder="Enter criteria here..."> 
                    <br>
					<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                    <input class="btn btn-primary mt-3" name="searchStock" type="submit" value="Submit"/>
          </form>  
          <div class="container mt-2">
          <c:if test="${not empty param.searchStock}">
