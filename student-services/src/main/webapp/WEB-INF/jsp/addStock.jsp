...
<body class="bg-light">
    <!-- Create navigation for the website within a <header> tag -->
     ...
     <h1 class="text-center">Add a stock for sale</h1>
     	<div class="row">
        <div class="col text-center mt-2">
          <form:form method="POST" action="/addStockResult" modelAttribute="stock" enctype="multipart/form-data">
          			<label class="d-block mt-2" for="sName">Name of stock</label>
                    <form:input class="form-control" name="sName"  type="text" minlength="1" maxlength="60" autofocus="true" placeholder="Lacalut" path="stockName"/>
                    <label class="d-block mt-2" for="mUnits">Select a measuring unit for the stock</label>
                    <form:select class="form-control" name="mUnits" path="measuringUnits">
                    ...
                    <form:input class="form-control" name="wOne"  type="number" min="0.1" step="0.1" placeholder="4.4" path="weightOne"/>
                    <p id="weightOneMessage"></p>
                    <label class="d-block mt-2" for="quant">Quantity of Item for Sale</label>
                    <form:input class="form-control" name="quant" type="number" placeholder="200" path="quantity"/>
                    <p id="quantMessage"></p>
                    <label class="d-block mt-2" for="pPerItem">Price Per Item in levs</label>
                    <form:input class="form-control" name="pPerItem" type="number" step="0.01"  min="0" placeholder="5.45" path="pricePerItem"/>
                    <p id="priceMessage"></p>
                    ...
                    <br>
                    <label class="d-block mt-2" for="file">Upload a thumbnail image of the stock</label>
                     <input class="form-control-file" type="file" name="file">
                     <br>
                     <label class="d-block mt-2"  for="sDesc">Give a short description of the stock</label>
                     <form:textarea class="form-control" placeholder="A fantastic product that allows you to..." path="stockDesc"></form:textarea>
                    <br>
