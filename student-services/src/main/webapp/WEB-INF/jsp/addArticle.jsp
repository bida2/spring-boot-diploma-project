    ...
    <!-- Create navigation for the website within a <header> tag -->
     ...
     <h1 class="text-center">Add an article</h1>
        ...
        <div class="col text-center mt-2">
          <form:form method="POST" action="/addArticle" modelAttribute="article">
          			<label class="d-block mt-2" for="aName">Title of article</label>
                    <form:input class="form-control" name="aName"  type="text" minlength="1" maxlength="120" autofocus="true" placeholder="New addition!..." path="articleTitle"/>
                    <label class="d-block mt-2" for="aText">Article Text</label>
                    <form:textarea class="form-control" name="aText"  type="text" placeholder="Article text goes here!" path="articleText"/>
                    <br>
                    <input class="btn btn-primary mt-2" name="articleSubmit" type="submit" value="Submit"/>
          </form:form>
          ${result}
        </div>
     	</div>
