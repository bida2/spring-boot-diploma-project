...
<body class="bg-light">
    <!-- Create navigation for the website within a <header> tag -->
     ...
     <main class="container text-center">
         <form:form class="mt-2" method="POST" action="/addStockGroup" modelAttribute="stockGroup">
         	<form:label for="stockGroupName" path="stockGroupName">
         		Enter the name of a new stock group
         	</form:label> 
         	<br>
         	<form:input class="form-control" type="text" path="stockGroupName" placeholder="Pesticides"/>
         	<p id="stockGroupMessage"></p>
    ...
    <script src="js/addStockGroupValidation.js"></script>
</body>
